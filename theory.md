...
<center>$ V_{dc} = \frac {1}{2\pi} [\int_{\alpha}^{\pi} V_{max}\, sin \, \omega t \, d(\omega t)+\int_{\pi}^{2\pi}(0)d(\omega t)] $</center><br>
...
<center><img src="images\RL load.PNG " height="300"></center>
...
<center>$\theta_1 = sin^{-1}(\frac{E}{V_m}).......(12)$</center><br>
...
<center>$I_o = \frac {1}{ 2 \pi R}[V_m (cos \alpha +cos  \theta_1)-E( \pi - \theta_1- \alpha)].......(17)$</center><br>
